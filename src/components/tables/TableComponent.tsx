...
import { useCreateProductMutation, useUpdateProductMutation } from "@/services/ecommerce";
...
export function DataTable<TData, TValue>({
  ...
  const newProduct = {
    name: "ehh der vh hz",
    description:
      "Premium ultrabook with a stunning InfinityEdge display",
    computerSpec: {
    ...
    thumbnail:
      "https://i.pinimg.com/control1/1200x/6b/3e/27/6b3e2732f2d45ee33e45f5349051232c.jpg",
